           ...
           <header className="header">
            ...
            <section id="about-us-selection" className="about-us-section">
                ...
                <p>Welcome to our Mobile Charity platform, powered by TON technology, where you can make a tangible difference with just a few taps on your phone. We believe that every act of kindness, no matter how small, has the potential to transform lives and communities.
                    ...
                    Thank you for being a mobile hero of change with our TON-powered Mobile Charity. Together, we can bring hope, relief, and smiles to countless lives.</p>
            </section>
            <section id="contact-us-section" className="contact-us-section">
                <h2>Contact Us</h2>
                <p id="Email">Email (real email, that could be used to contact us, we would really like to hear your feedback, it will change after the full launch of the twa): <a href="mailto:petrovzahar160@gmail.com"> petrovzahar160@gmail.com</a></p>
            </section>
        </div>
    );
}
